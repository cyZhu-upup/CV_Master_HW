...
class FCOS(M.Module):
    ...
    def __init__(self, cfg):
        ...
        del bottom_up.fc  # 删除backbone的分类网络
        ...
        # ----------------------- build FCOS Head ----------------------- #
        self.head = layers.PointHead(cfg, feature_shapes)  # 用于分类和回归，外加一个centerness打分
    ...
    def forward(self, image, im_info, gt_boxes=None):
        ...
        features = [features[f] for f in self.in_features]  #  p3->p7
...
class FCOSConfig:
    ...
    def __init__(self):
        ...
        # ----------------------- net cfg ------------------------- #
        self.stride = [8, 16, 32, 64, 128]  # FPN stride
